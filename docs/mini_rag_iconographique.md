...
2. **Recherche visuelle** — cosinus contre `X_index` (2638 illustrations : 447 Bibles + 2191 Ovide).
...
## Thèmes précis (section dédiée de `vector_base.ipynb`)
...
l'autre — seulement les métadonnées d'édition.
